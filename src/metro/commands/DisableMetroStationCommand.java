...
public class DisableMetroStationCommand implements Command {
    @Override
    public void execute(String[] args) {
        ...
        if (!Database.isMetroLineExists(metroLineName)) {
            ...
            Database.disableMetroStation(metroLineName, metroStationName);
            System.out.println(metroStationName + " (" + metroLineName + ") is now under maintenance and is not available for travel.");
        }
    }
}
